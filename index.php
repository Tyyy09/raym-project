        ...
        <div class="grid">
            ...
            <article class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="product.php?slug=air-jordan-1" class="btn">View Product</a>
                </div>
            </article>
            ...
            <article class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="product.php?slug=yeezy-boost-350" class="btn">View Product</a>
                </div>
            </article>
            ...
            <article class="card">
                ...
                <div class="card-content">
                    ...
                    <p class="price">$130.00 CAD</p>
                    <a href="product.php?slug=reebox-c85-vintage" class="btn">View Product</a>
                </div>
            </article>
            ...
            <article class="card">
                ...
                <div class="card-content">
                    ...
                    <a href="product.php?slug=adidas-samba-og" class="btn">View Product</a>
                </div>
            </article>
            ...
            <article class="card">
                ...
                <div class="card-content">
                    <h3>Nike Dunk Low</h3>
                    <p class="price">$160.00 CAD</p>
                    <a href="product.php?slug=nike-dunk-low" class="btn">View Product</a>
                </div>
            </article>
